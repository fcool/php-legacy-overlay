...
RDEPEND="
        ...
        dev-php/pcre
        php_targets_php7-4? ( <dev-php/psr-log-3 )
        !php_targets_php7-4? ( dev-php/psr-log )
        ...
        php_targets_php7-4? ( <dev-php/symfony-console-6 )
        !php_targets_php7-4? ( dev-php/symfony-console )
        php_targets_php7-4? ( <dev-php/symfony-filesystem-6 )
        !php_targets_php7-4? ( dev-php/symfony-filesystem )
        php_targets_php7-4? ( <dev-php/symfony-finder-6 )
        !php_targets_php7-4? ( dev-php/symfony-finder )
        dev-php/symfony-polyfill-php73
        dev-php/symfony-polyfill-php80
        dev-php/symfony-polyfill-php81
        php_targets_php7-4? ( <dev-php/symfony-process-6 )
        !php_targets_php7-4? ( dev-php/symfony-process )
        dev-php/xdebug-handler
        php_targets_php7-4? ( <dev-php/symfony-string-6 )
"
